                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            <div class="flex flex-col text-center w-full mb-3">
                                <h1 class="sm:text-2xl font-medium title-font text-gray-900">オーナー情報編集
                                </h1>
                            </div>
                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="p-2">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="name" name="name" value="{{ $owner->name }}" requierd
                                    ...
                                    <div class="p-2">
                                        <div class="relative">
                                            ...
                                            <input type="email" id="email" name="email" value="{{ $owner->email }}" requierd
                                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
