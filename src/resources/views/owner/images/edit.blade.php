                    ...
                    <form method="post" action="{{ route('owner.images.update', ['image' => $image->id]) }}">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <div class="mt-2">
                                ...
                                <button type="submit" class="text-white bg-blue-500 border-0 py-2 px-8 ml-3 focus:outline-none hover:bg-blue-600 rounded text-lg">更新する</button>
                            </div>
                        </div>
                    </form>
                    <form id="delete_{{ $image->id }}" method="post" class="mt-10"
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <a href="#" data-id="{{ $image->id }}"
                                ...
                                class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded text-lg inline-block ">画像を削除する</a>
                        </div>
                    </form>
                </div>
            </div>
